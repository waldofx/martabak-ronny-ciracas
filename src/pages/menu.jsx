    ...
    return (
        <div className="bg-gray-100">
            ...
            <div className="container mx-5 text-center">
                ...
                <p className="mb-5">Setelah memilih yang ingin dipesan, silahkan klik tombol pesan dibawah.</p>
                <div className="mb-10">
                    <div class="p-6 border border-gray-300 sm:rounded-md md:w-96 md:max-w-full mx-auto mt-5">
                    ...
                    <p className="mb-5">
                        Atau bisa langsung membaut pesanan melalui Whatsapp <strong> No 0822-6067-9579 </strong> atau Klik di sini
                        <a
